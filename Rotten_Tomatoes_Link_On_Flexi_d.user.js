...
// @include	https://ipfs.io/ipfs/QmVHdqoC7RtjRKbwTU8LxnpJSJCuy6Bt4SPBAyEyeP9dEg/flexi/tt*
// @noframes
...
GM_xmlhttpRequest({
	method: "GET",
	url: "https://ipfs.io/ipfs/QmVHdqoC7RtjRKbwTU8LxnpJSJCuy6Bt4SPBAyEyeP9dEg/flexi/" + IMDbID + ".html",
	onload: function(response) {
		var flexi = response.status
		if (flexi != 403) {
			addButton("https://ipfs.io/ipfs/QmVHdqoC7RtjRKbwTU8LxnpJSJCuy6Bt4SPBAyEyeP9dEg/flexi/" + IMDbID + ".html");
		}
		else if (flexi) {
